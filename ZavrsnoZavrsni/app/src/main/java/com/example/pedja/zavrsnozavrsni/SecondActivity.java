package com.example.pedja.zavrsnozavrsni;
...
import static com.example.pedja.zavrsnozavrsni.MainActivity.NOTIF_STATUS;
import static com.example.pedja.zavrsnozavrsni.MainActivity.NOTIF_TOAST;

/**
 * Created by Pedja on 11/25/2016.
 */
...
public class SecondActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.add_movie_detail:
                //OTVORI SE DIALOG UNESETE INFORMACIJE
                final Dialog dialog = new Dialog(this);
                dialog.setContentView(R.layout.add_movie);

                Button add = (Button) dialog.findViewById(R.id.add_movie_button);
